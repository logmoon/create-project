...
Read `.opencode/conventions.md` before writing the diff. A proposal that pads a skill with encouragement instead of instruction, or duplicates something a context file already says, is the kind of thing that convention doc exists to catch before it ships.
